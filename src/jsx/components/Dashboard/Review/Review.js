...
import pic5 from "../../../../images/profile/5.jpg";
import pic6 from "../../../../images/profile/6.jpg";
import pic7 from "../../../../images/profile/7.jpg";

const reviewTable = [
  { image: pic5, title: "James Sitepu" },
  { image: pic6, title: "Angela Moss" },
  { image: pic7, title: "Daphne Roshan" },
  { image: pic5, title: "James Sitepu" },
  { image: pic6, title: "Angela Moss" },
  { image: pic7, title: "Daphne Roshan" },
];
    ...
    return (
      <Fragment>
        <div className="form-head d-flex mb-3 mb-lg-5 align-items-start">
          ...
          <Link
            to={"#"}
            className="btn btn-success ms-auto btn-rounded d-md-flex align-items-center d-inline-block"
          >
            <svg
          ...
          <Link
            to={"#"}
            className="btn btn-danger ms-3 btn-rounded d-md-flex align-items-center d-inline-block"
          >
            <svg
              className="me-2 scale5"
              width="16"
          ...
          <div className="input-group search-area ms-3 d-inline-flex">
            <input
              type="text"
          ...
          <div className="col-xl-12">
            <div className="card review-table p-0 border-0">
              {reviewTable.map((item, ind) => (
                <div
                  className="row align-items-center p-4  border-bottom"
                  key={ind}
                >
                  <div className="col-xl-4 col-xxl-4 col-lg-5 col-md-12">
                    <div className="media align-items-center">
                      ...
                      <div className="card-body p-0">
                        <p className="text-primary fs-14 mb-0">{`#C0123${ind + 3}`}</p>
                        <h3 className="fs-20 text-black font-w600 mb-2">
                          <Link to={"/app-profile"} className="text-black">
                            {item.title}
                          </Link>
                        </h3>
                        <span className="text-dark">26/04/2023, 12:42 AM</span>
                      </div>
                    </div>
                  </div>
