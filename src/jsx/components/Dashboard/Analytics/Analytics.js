...
const selerBlog = [{ image: pic11 }, { image: pic12 }, { image: pic11 }];
                        ...
                        <div className="card-body p-1">
                          <div className="sp15 row border-bottom favorites-items p-3 align-items-center p-sm-4">
                              ...
                              <div className="media align-items-center">
                                <Link to={"/ecom-product-detail"}>
                                  <img
                                    ...
                                    src={require("./../../../../images/card/pic4.jpg")}
                                    alt=""
                                    width="105"
                                  />
                                </Link>
                                <div className="media-body">
                                  ...
                                  >
                                    <i className="fa fa-heart fs-20 me-2" />{" "}
                                    <strong className="me-1">256k</strong>Like
                                    it
                                  </Link>
                                </div>
                              </div>
                            ...
                            <div className="col-xl-3 col-lg-3 col-sm-4 col-12 media align-items-center">
                              ...
                              <div className="media-body">
                                <h3 className="text-black font-w600 mb-1">
                                  45%
                                </h3>
                            ...
                            <div className="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
                              <div className="media align-items-center">
                                <Link to={"/ecom-product-detail"}>
                                  <img
                                    className="rounded me-3"
                                    src={require("./../../../../images/card/pic2.jpg")}
                                    alt=""
                                    width="105"
                                  />
                                </Link>
                                <div className="media-body">
                                  ...
                                  >
                                    <i
                                      className="fa fa-heart fs-20 me-2"
                                      aria-hidden="true"
                                    ></i>{" "}
                                    <strong className="me-1">256k</strong> Like
                                    it
                            ...
                            <div className="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
                              <div className="media align-items-center">
                                <Link to={"/ecom-product-detail"}>
                                  <img
                                    className="rounded me-3"
                                    src={require("./../../../../images/card/pic7.jpg")}
                                    alt=""
                                    width="105"
                                  />
                                </Link>
                ...
                <div className="card-header border-0">
                  ...
                  <Dropdown>
                    <Dropdown.Toggle
                      as="button"
                      type="button"
                      className="btn border  btn-rounded text-black"
                    >
                      Monthly
                    </Dropdown.Toggle>
                    <Dropdown.Menu>
                ...
                <div className="card-body">
                  ...
                  <div className="media align-items-center">
                    <Link to={"/app-profile"}>
                      <img
                        className="me-3 rounded"
                        src={require("../../../../images/profile/10.jpg")}
                        width="70"
                        alt=""
                      />
                    </Link>
