...
const AddBlueprintModal = ({ show, handleClose, onAdd }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error("Failed to create blueprint:", errorData.message);
        alert(`Failed to create blueprint: ${errorData.message}`);
      }
    } catch (error) {
  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>Add New Blueprint</Modal.Title>
      </Modal.Header>
